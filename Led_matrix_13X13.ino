...
#define WS2812_pin 7 // only digital pin 8 works right now
//#define numberOfLEDs 256// total number of RGB LEDs
#define numberOfLEDs 169// total number of RGB LEDs
byte RGB[507];//take your number of LEDs and multiply by 3
...
void loop() {
  ...
  mapLEDXY(0,0,0,0,10);mapLEDXY(1,1,0,0,10);mapLEDXY(2,2,0,0,10);mapLEDXY(3,3,0,0,10);mapLEDXY(4,4,0,0,10);mapLEDXY(5,5,0,0,10);mapLEDXY(6,6,0,0,10);mapLEDXY(7,7,0,0,10);mapLEDXY(8,8,0,0,10);mapLEDXY(9,9,0,0,10);mapLEDXY(10,10,0,0,10);mapLEDXY(11,11,0,0,10);mapLEDXY(12,12,0,0,10);mapLEDXY(13,13,0,0,10);
  RGB_update(-1, 0, 0, 0);
  delay(1000);
  clearLEDs();
  RGB_update(-1, 0, 0, 0);
